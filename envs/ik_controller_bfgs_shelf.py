...
from ik_controller_bfgs_rot.wrapper import solve_ik
...
class IKController:
    ...
    def solve(self, q, obstacles, target_pos, target_rot):
        options = {
            ...
            "population": 200, #number of gaussian generated
            "sigma": 0.1,  # standard deviation of gaussian

            "skip": 2, # search with i = i + skip
        ...
        q_res, f_res = solve_ik(q, obstacles, target_pos, target_rot, options)
