...
extern "C" {
    ...
    void solve_ik(const float q[7], const Obstacle obstacles[4], const float target_pos[3], const Options* options, float q_res[7], float* f_res) {
...
//            if (dist > 0
//            && res.first[0]>-2.8973 && res.first[0]<2.8973 && res.first[1]>-1.7628 && res.first[1]<1.7628
//            && res.first[2]>-2.8973 && res.first[2]<2.8973 && res.first[3]>-3.0718 && res.first[3]<-0.0698
//            && res.first[4]>-2.8973 && res.first[4]<2.8973 && res.first[5]>-0.0175 && res.first[5]<3.7525
//            && res.first[6]>-2.8973 && res.first[6]<2.8973) {
////                std::cout<<cached_pop.size()<<std::endl;
//                break;
//            }
            if (dist > 0
                && res.first[0]>-2.8 && res.first[0]<2.8 && res.first[1]>-1.7 && res.first[1]<1.7
                && res.first[2]>-2.8 && res.first[2]<2.8 && res.first[3]>-3 && res.first[3]<-0.06
                && res.first[4]>-2.8 && res.first[4]<2.8 && res.first[5]>-0.015 && res.first[5]<3.6
                && res.first[6]>-3.25 && res.first[6]<1.75) {
//                std::cout<<cached_pop.size()<<std::endl;
                break;
            }
        }
